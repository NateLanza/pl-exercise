 ...
 * @returns 
 */
export const Slider: React.FC<SliderProps> = ({ x, y, value, width, height, min, max, color, title, unit, onChange }) => {
  ...
  return (
    <g transform={`translate(${x}, ${y})`}>
      ...
      <text width={width} textAnchor='middle' x={width / 2} y={height + 15} fontSize={LABEL_SIZE}>{curValue.toFixed(1)} {unit}</text>
